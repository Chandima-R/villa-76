...
const timeline = [
    {
        year: "2018",
        title: "The Villa Opens",
        text: "Villa 76 welcomes its first guests — three families who fell in love with the quiet stretch of beach at Kapparatota and asked if they could come back the following year."
    },
    {
        year: "2020",
        title: "A Private Retreat",
        text: "Fully refurbished with new en-suite bathrooms in every room, a redesigned communal terrace, and an expanded kitchen. The villa takes shape as a true home-away-from-home."
    },
    {
        year: "2022",
        title: "Rated 9.4 / 10",
        text: "Over 18 verified guest reviews on Booking.com push the villa to a 9.4 rating — placing it among the top-rated properties on the entire Weligama stretch."
    },
    {
        year: "2024",
        title: "Coastal Concierge",
        text: "We launch a bespoke concierge service — private chefs, surf lessons, whale watching arrangements, and airport transfers — making Villa 76 a full-service sanctuary."
    },
];
...
export const AboutPage = () => {
    ...
    return (
        ...
        <span
            className="ab-scroll-text display text-[10vw] font-light whitespace-nowrap text-[#0C1E33] leading-none select-none"
          ...
          VILLA 76 · WELIGAMA · SOUTHERN COAST · SRI LANKA · INDIAN OCEAN ·
                ...
                <div className="max-w-[1600px] mx-auto grid lg:grid-cols-[1.3fr_1fr] gap-16 lg:gap-28 items-center">
                    ...
                    <div className="flex flex-col gap-8">
                        <p className="ui text-[14px] leading-[1.95] text-[#A8A399]">
                            Villa 76 is not a hotel. It is a three-bedroom private villa, managed personally and
                            maintained to an exacting standard, that has become a quiet favourite on Sri Lanka's
                            southern coast.
                        </p>
                        <p className="ui text-[14px] leading-[1.95] text-[#A8A399]">
                            From the sunbathing terrace to the spacious communal kitchen — every element of the property
                            has been designed to feel like a home that happens to sit 80 metres from one of the most
                            beautiful bays in the Indian Ocean.
                        </p>
                        <div className="ab-stats grid grid-cols-3 gap-5 pt-6 border-t border-[#1C3B58]/40">
                            {[{n: "2018", l: "Est."}, {n: "9.4", l: "Rating"}, {n: "3", l: "Suites"}].map(s => (
                                <div key={s.l} className="ab-stat">
                                    <span
                                        className="display text-[44px] font-light text-[#C9A96E] block leading-none mb-1">{s.n}</span>
                                    <span
                                        className="ui text-[9px] tracking-[.22em] uppercase text-[#A8A399]/50">{s.l}</span>
                                </div>
                            ))}
                        </div>
                    </div>
                    ...
                    <div className="ab-timeline grid lg:grid-cols-4 gap-0">
                        {timeline.map((t, i) => (
                            <div key={t.year}
                                ...
                                {/* Dot */}
                                <div
                                    className="absolute -left-[5px] top-0 lg:left-0 lg:-top-[5px] w-[9px] h-[9px] rounded-full bg-[#C9A96E] border-2 border-[#04090F]"/>
                                <span
                                    className="display text-5xl font-light text-[#C9A96E]/20 block mb-2 mt-4 lg:mt-6">{t.year}</span>
            ...
            {/* Location section */}
            <section className="relative py-28 lg:py-40 px-8 lg:px-14 bg-[#071220] overflow-hidden">
                <div className="orb orb-gold w-[500px] h-[500px] bottom-0 left-0 opacity-18"/>
                <div className="max-w-[1600px] w-full mx-auto grid lg:grid-cols-2 gap-16 lg:gap-28">
                    <div>
                        ...
                        <p className="ui text-[14px] leading-[1.9] text-[#A8A399] mb-10">
                            Villa 76 sits in the quiet residential lane of Kapparatota — away from the noise of the main
                            town but within 5 minutes of everything Weligama offers. The beach is an 80-metre walk. The
                            world-famous surf break is visible from the terrace.
                        </p>
                        <div className="flex flex-col gap-2 mb-10">
                            <p className="ui text-[11px] tracking-[.2em] uppercase text-[#C9A96E]/50 mb-2">Full
                                Address</p>
                        ...
                        <a href="https://maps.google.com/?q=Weligama+Sri+Lanka" target="_blank"
            ...
            <section className="bg-[#04090F] px-8 lg:px-14 pb-0">
              ...
              <span className="display text-[5vw] font-light text-[#EAE6DE]/60"
                    style={{fontFamily: "var(--font-display)"}}>
                6.0535° N — 80.4481° E
              </span>
