...
export const Navbar = ()=> {
    ...
    return (
        <>
            <nav className={`fixed top-0 inset-x-0 z-[500] transition-all duration-700 ${scrolled ? "py-4 bg-[#04090F]/92 backdrop-blur-xl border-b border-[#1C3B58]/35" : "py-7"}`}>
                <div className="px-8 lg:px-14 flex items-center justify-between">
                    ...
                    <Link href="/" className="flex flex-col leading-none group">
                        ...
                        <span className="ui text-[8px] tracking-[.55em] text-[#C9A96E]/45 group-hover:text-[#C9A96E]/75 transition-colors uppercase">76 · Weligama</span>
                    </Link>
                ...
                {open && (
                    ...
                    >
                        ...
                        <div className="absolute w-[400px] h-[400px] rounded-full"
                             style={{ background: "radial-gradient(circle, rgba(91,155,181,.08) 0%, transparent 70%)", filter: "blur(80px)" }} />
                        ...
                        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: .55 }} className="mt-4">
